...
// Updated data arrays matching the prompt's design requirements, color references, and Indian context
const SERVICES = [
  {
...
const FEATURES = [
  { title: "500+ Homes Designed", desc: "Successfully transformed luxury homes across premier Indian high-rises.", icon: "🏠", bg: "bg-emerald-50 text-emerald-700 border-emerald-100" },
  { title: "10+ Years Experience", desc: "Setting benchmarks in structural excellence and spatial innovation since a decade.", icon: "✨", bg: "bg-amber-50 text-amber-700 border-amber-100" },
  { title: "Premium Materials", desc: "Handpicked multi-ply frameworks, marine boards, and genuine European hardware.", icon: "🛡️", bg: "bg-blue-50 text-blue-700 border-blue-100" },
  { title: "On-Time Delivery", desc: "Rigorous milestone scheduling backed by absolute strict timeline handovers.", icon: "📅", bg: "bg-rose-50 text-rose-700 border-rose-100" },
  { title: "Free Consultation", desc: "Deep design interaction cycles and meticulous 3D spatial roadmap plotting completely free.", icon: "🎨", bg: "bg-purple-50 text-purple-700 border-purple-100" },
  { title: "5 Year Warranty", desc: "Comprehensive structural warranty ecosystem ensuring absolute long-term peace of mind.", icon: "⭐", bg: "bg-orange-50 text-orange-700 border-orange-100" },
];
...
export default function Home() {
  return (
    <>
      ...
      <main className="bg-[#F8F3EC] text-[#2E2E2E] min-h-screen selection:bg-[#D4AF37] selection:text-white overflow-x-hidden antialiased">
        
        {/* Fullscreen Premium & Luxurious Hero Section */}
        
        <section className="relative min-h-[95vh] flex items-center bg-gradient-to-br from-[#2E2E2E] via-[#3A3A3A] to-[#1F2E26] text-white pt-24 overflow-hidden">
          {/* Subtle floating ambient background shapes */}
          
          <div className="absolute top-1/4 left-10 w-72 h-72 bg-[#D4AF37]/10 rounded-full blur-3xl animate-pulse" />
          <div className="bottom-10 right-1/4 w-96 h-96 bg-[#8B5E3C]/10 rounded-full blur-3xl" />
          
          <div className="relative max-w-7xl w-full mx-auto px-6 py-12 grid lg:grid-cols-12 gap-12 items-center z-10">
            <div className="lg:col-span-7 space-y-6 text-left">
              <div className="inline-flex items-center gap-2 rounded-full border border-[#D4AF37]/40 bg-[#D4AF37]/10 px-4 py-1.5 text-[#D4AF37] text-sm tracking-wide backdrop-blur-md">
                <span className="h-2 w-2 rounded-full bg-[#D4AF37] animate-ping" />
                Architectural Opulence • Crafted Across India
              </div>

              <h1 className="font-serif leading-[1.15] tracking-tight text-4xl sm:text-6xl xl:text-7xl font-bold">
                Elevating Spaces.<br />
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <Link
                  href="/booking"
                  className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#8B5E3C] px-8 py-4 font-semibold text-white shadow-xl shadow-black/30 transform transition-all duration-300 hover:-translate-y-1 hover:brightness-110 focus:outline-none"
                >
                  Book Free Consultation
                </Link>
                <Link
                  href="/portfolio"
                  className="inline-flex items-center justify-center rounded-xl border border-zinc-500 bg-white/10 backdrop-blur-md px-8 py-4 font-semibold text-white shadow-lg transform transition-all duration-300 hover:bg-white/20 hover:-translate-y-1 focus:outline-none"
                >
                  Explore Portfolio
                </Link>
              </div>

              {/* Floating Counter Stats Block embedded inside hero */}
              <div className="pt-8 grid grid-cols-4 gap-2 border-t border-white/10 max-w-xl">
                {[
                  { v: "500", k: "Homes Completed", s: "+" },
                  { v: "1000", k: "Happy Clients", s: "+" },
                  { v: "45", k: "Days Delivery", s: "" },
                  { v: "4.9", k: "Customer Rating", s: "★" },
                ].map((stat) => (
                  <div key={stat.k} className="space-y-0.5">
                    <div className="text-xl sm:text-2xl font-bold text-[#D4AF37] tracking-tight">
                      <AnimatedCounter value={stat.v} suffix={stat.s} />
                    </div>
                    <div className="text-zinc-400 text-[11px] sm:text-xs tracking-normal font-light leading-tight">{stat.k}</div>
                  </div>
                ))}
              </div>
            </div>

            {/* Luxury Indian Living Room Image Container */}
            <div className="lg:col-span-5 relative hidden lg:block">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-white/10 group bg-zinc-900">
                <img
                ...
                <div className="absolute bottom-6 left-6 right-6 p-5 rounded-2xl bg-[#2E2E2E]/80 border border-zinc-700/50 backdrop-blur-md">
                  <p className="text-xs font-semibold text-[#D4AF37] tracking-widest uppercase">Signature Concept</p>
                  <p className="text-zinc-200 font-light mt-1 text-sm">Modern Indian living room woven with rich wooden accents and brass luxury trims.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Section 3: Why Choose Us (Premium, Modern & Luxurious Makeover) */}
<section className="relative py-28 overflow-hidden bg-gradient-to-b from-[#F8F3EC] via-white to-[#F8F3EC]">
  {/* Decorative luxury background shapes & blurred glowing circles */}
  <div className="absolute top-12 left-[-10%] w-[45rem] h-[45rem] bg-gradient-to-tr from-[#D4AF37]/10 via-[#8B5E3C]/5 to-transparent rounded-full blur-[120px] pointer-events-none animate-[pulse_8s_infinite_ease-in-out]" />
  <div className="absolute bottom-12 right-[-10%] w-[35rem] h-[35rem] bg-gradient-to-bl from-[#8B5E3C]/10 via-[#D4AF37]/5 to-transparent rounded-full blur-[100px] pointer-events-none animate-[pulse_10s_infinite_ease-in-out]" />

  <div className="max-w-7xl mx-auto px-6 relative z-10">
    
    {/* Luxury Heading & Small Subtitle Container */}
    ...
    {/* Staggered Grid Layout with Glassmorphism Cards */}
    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 items-start">
      {[
        ...
        },
        {
          ...
          delay: "lg:translate-y-6" // Meticulous staggered vertical visual dynamic
        },
        {
        ...
        >
          {/* Subtle micro glow aura inside card */}
          ...
          <div className="space-y-5">
            {/* Upper row: Rich Gradient Icon Cluster & Inline Stat Badge */}
            ...
            {/* Animated Interactive "Learn More" Luxury Arrow indicator */}
        ...
        {/* Section 4: How We Work (Horizontal Timeline Layout) */}
        <section className="py-24 max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6 relative">
            {/* Horizontal progress connector lines for desktop */}
        ...
        {/* Section 5: Featured Projects Layout (Portfolio Preview) */}
        <section className="py-24 bg-[#F1EAE0] border-y border-zinc-200">
          <div className="max-w-7xl mx-auto px-6">
            ...
            {/* Masonry-style Grid Layout containing 8 premium subjects */}
        ...
        <section className="py-20 relative overflow-hidden bg-gradient-to-br from-[#2E2E2E] to-[#1F2E26] text-white text-center">
          ...
          <div className="relative max-w-4xl mx-auto px-6 space-y-6 z-10">
            ...
            <div className="pt-4">
              <Link
                href="/booking"
                className="inline-block rounded-xl bg-gradient-to-r from-[#D4AF37] via-amber-500 to-[#8B5E3C] px-10 py-4 font-semibold text-white text-base shadow-2xl shadow-black/40 transform transition-all duration-300 hover:scale-105 hover:brightness-110"
              >
                Book Free Consultation
              </Link>
            </div>
